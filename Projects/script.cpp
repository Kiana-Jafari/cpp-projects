/*
  This project aims to design and implement a store inventory management system. 
  The program can read products from a text file, add products, display items with their information, 
  calculate the inventory value of each product, show the low-stock items, search for a specific product, sort the products using Bubble Sort (from scratch),
  edit the info of a specific product, remove a specific product, and save the product back to the text file.
*/
